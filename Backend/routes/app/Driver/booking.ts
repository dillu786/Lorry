...
import { acceptedBookings, acceptRide, onGoingRide, completedRides, startTrip, makeDriverOnline, makeDriverOffline, negotiateFare, newBookings, endTrip, getDriverBookingHistory  } from "../../../controllers/app/Driver/booking";
...
router.get("/historicalRides",Drivermiddleware,getDriverBookingHistory);
